...
public class MadLibs {
    ...
    public void enterAdverb(){
        System.out.println("I realy want an adverb.");
    ...
    public void putTogetherTheStory(){
        ...
        if (num == 0 ) {
            story = "Jesse and her best friend " + getName() + " went  to Disney World today! "
                    ...
                    + " ran " + getAdjective2() + " to meet Mickey Mouse in his " + getNoun2() + " and that night I gazed at the "
            ...
            story = " Amanda and her frenemy" + getName() + " went to the zoo last summer. "
                    + "they saw a huge " + getNoun1() + "i and a tiny little "
                    + "and ate a " + getAdjective1() + " feast for dinner. THe next day I"
                    + " ran " + getAdjective2() + " to meet Mickey Mouse in his " + getNoun2() + " and that night I gazed at the "
                    + getRandomNums() + " " + getAdjective2() + " fireworks shooting from the " + getNoun3() + ".";
        }
